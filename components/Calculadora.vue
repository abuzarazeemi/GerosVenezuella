<template>
  <v-main>
    ...
    <v-card class="py-2 pb-2 mb-4 b-shadow" min-width="auto">
      <v-btn
        to="/dashboard"
        class="pa-1 ma-0"
        elevation="0"
    ...
    <div
      class="d-flex flex-column flex-wrap justify-space-between align-center pb-4 flex-sm-nowrap flex-sm-row"
      height="auto"
    >
      <v-card
      ...
      >
        <div class="map-layout">
          <iframe
            ...
            marginheight="0"
            marginwidth="0"
            src="https://maps.google.com/maps?width=100%25&amp;height=200&amp;hl=en&amp;q=4.585442080159303,%20-74.10049879836808+(Giros%20Venezuela)&amp;t=&amp;z=18&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
          >
            <a href="https://www.gps.ie/farm-gps/">gps for tractors</a>
          </iframe>
          <p>
            DIRECCION: CL 17 #17-42 BARRIO ANTONIO NARINO, PUERTO TEJADA CAUCA
          </p>
          <p>CODIGO POSTAL: 191501</p>
          <p>TELÉFONO: +57 (602)828-53-58</p>
          <p>CÉLULA/WHATSAPP: (+57) 313.708.20.46</p>
        </div>
        <small class="body-2 grey--text font-weight-medium">
          {{ setTime }}
        </small>
            ...
            <template v-slot:default>
              <thead>
                <tr>
                  ...
                  <th class="text-left">Tasa Aplicada</th>
